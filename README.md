...
- Решение:
  ...
  3. Создаваемые данные:
    - отдел по работе с клиентами в основном создает первичный заказ и данные по спецификации загружает за раз 100 позиций при создании Блоков монтажа и при создании заказа создает новых записей в среднем 2000 позиций.
